...
public class OpenCVFaceRecognizer {
    public static void main(String[] args) {
        ...
        Mat testImage = imread("C:\\Users\\shipulin.mihail\\Desktop\\test\\1.jpg", CV_LOAD_IMAGE_GRAYSCALE);
        ...
        faceRecognizer.save("C:\\Users\\shipulin.mihail\\Desktop\\test\\FaceDB.yml");
        IntPointer label = new IntPointer(1);
        DoublePointer confidence = new DoublePointer(1);
        faceRecognizer.predict(testImage, label, confidence);
        int predictedLabel = label.get(0);
        System.out.println(sdf.format(new Date(System.currentTimeMillis()))+ " Predicted label: " + predictedLabel+" confidence: "+confidence.get());
    }
}
